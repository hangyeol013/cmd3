...
NUM_CLASSES = 3
class CMD3Multi(LightningModule):
    def __init__(
        self,
        ...
        self.video_pretrained_path = video_feature_path
        self.audio_pretrained_path = audio_feature_path

        self.model = nn.Linear(6968*2,3)
