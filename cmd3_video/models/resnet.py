...
def make_resnet(
    ...
    """Load a standard 3D resnet architecture.
    :param model_depth: depth of the resnet (currently supported: 18 and 50).
    :param num_classes: number of output class.
    :param pretrained_path: if provided load the model stored at this location.
    :param feature_extraction: if loading a pretrained model, wether to fine
        tune (`False`) or to use only feature extraction (`True`).
